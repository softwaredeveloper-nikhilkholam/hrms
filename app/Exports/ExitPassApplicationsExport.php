...
class ExitPassApplicationsExport implements FromCollection, WithHeadings, WithEvents
{
    private $month;
    private $type;
    private $rowCount;
    ...
    public function collection()
    {
        ...
        if($type == 1)
        {
            ...
            foreach($applications as $application)
            {
                ...
                $temp['pendingCt'] = EmpApplication::where('type', 2)
                ...
                $temp['totalCt'] = EmpApplication::where('type', 2)
                ->where('empId', $application->empId)
                ->where('active', 1)
                ->where('startDate', '>=', $fromDate)
        ...
        else
        {
            ...
            'emp_applications.reason','emp_applications.description','emp_applications.created_at as appliedAt','emp_applications.timeout',
    ...
    public function headings(): array
    {
        ...
        if($type == 1)
            ...
            return ["Sr. No.","Date", "Code", "Employee Name", "Department", "Designation", "Reason", "Description", "ExitPass Filled At", "Exit Time", "Status","Updated At","Updated By"];
