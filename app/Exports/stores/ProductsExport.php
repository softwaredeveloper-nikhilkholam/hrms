...
class ProductsExport implements FromCollection, WithHeadings, WithEvents
{
    ...
    public function collection()
    {
        ...
        ->select('store_products.id as productId','store_categories.id as srNo', "store_products.name",'store_categories.name as categoryName', 
        ...
        foreach($temps as $product)
        {
            ...
            $temProduct['Stock'] =  $util->getCurrentProductStock($product->productId);
    ...
    {
        return ["No.","Product","Category", "Sub Category", "Size", "Color", "Hall", "Rack", "Shelf", "Stock", "Valuation"];
    }
