						...
						<div class="card">
							<div class="card-body">
								<a href="#">
									<div class="row">
										<div class="col-10">
											<div class="mt-0 text-left"> <span class="fs-14 font-weight-semibold">Aaryans World</span>
						...
						<div class="card">
							<div class="card-body">
								<a href="#">
									<div class="row">
										<div class="col-10">
											<div class="mt-0 text-left"> <span class="fs-14 font-weight-semibold">Tickets</span>
						...
						<div class="card">
							<div class="card-body">
								<a href="#">
									<div class="row">
										<div class="col-10">
											<div class="mt-0 text-left"> <span class="fs-14 font-weight-semibold">Joined {{date('M-y', strtotime('-1 month'))}}</span>
