	...
	<div class="container">                        
		...
		<div class="page-header d-xl-flex d-block">
			<div class="page-leftheader">
				<h4 class="page-title">{{$name}}<span class="font-weight-normal text-muted ml-2">Dashboard</span></h4>
			</div>
			<div class="page-rightheader ml-md-auto">
                <div class="d-flex align-items-end flex-wrap my-auto right-content breadcrumb-right">
                    <h6 class="page-title">Reporting: <b style="color:red;">{{$repoName}}</b></h6>
                </div>
            </div>
		</div>
        <div class="row">
								...
								<a href="#">
									<div class="row">
										<div class="col-10">
											...
											<h3 class="mb-0 mt-1  mb-2">{{$activeDesignations}}</h3> </div>
										</div>
										<div class="col-2">
						...
						<div class="card">
							<div class="card-body">
								<a href="#">
									<div class="row">
										<div class="col-10">
											<div class="mt-0 text-left"> <span class="fs-14 font-weight-semibold">Assets</span>
											<h3 class="mb-0 mt-1  mb-2">{{$activeAssets}}</h3> </div>
										</div>
										<div class="col-2">
											<div class="icon1 bg-secondary brround my-auto  float-right"> <i class="feather feather-dollar-sign"></i> </div>
										</div>
