    ...
    <div class="card-header">
        <div class="row">
            <div class="col-md-4 text-left">
                <h5 class="card-title">Deactive Assign Task List</h5>
            </div>
                    ...
                    @if($assignSheets)
                        @foreach($assignSheets as $row)
                            <tr>
                                ...
                                <td><a href="/CRM/masterchecklist/{{$row->id}}/activeDeactiveStatus" class="badge badge-pill badge-status bg-danger">✓</a></td>
                            </tr>
                        @endforeach
                    @endif
                </tbody>
