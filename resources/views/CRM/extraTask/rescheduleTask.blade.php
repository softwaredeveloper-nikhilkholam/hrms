...
<div class="card">
    <div class="card-header">
        <div class="row">
            <div class="col-md-4 text-left">
                <h5 class="card-title">Reschedule Task Details</h5>
            </div>
    ...
    <div class="card-body">
        {!! Form::open(['action' => 'CRM\ExtraWorksController@rescheduleTask', 'method' => 'POST', 'class' => 'form-horizontal form-row row']) !!}
    ...
    <div class="card-header">
        <div class="row">
            <div class="col-md-4 text-left">
                <h5 class="card-title">Reschedule Task To</h5>
            </div>
        </div>
    </div>
            <div class="row mt-3">
        ...
        <div class="row mt-3">
            ...
            <div class="col-md-4">
                <label class="form-label" for="birthDate">Reschedule Date Request</label>
            ...
            <div class="col-md-2">
                <label class="form-label" for="timeOfBirth">Reschedule Time </label>
            ...
            <div class="col-md-12 mt-3">
                <label class="form-label" for="validationTooltip02">Remarks (If Any)</label>
                <textarea class="form-control" name="task" rows="6" cols="3" placeholder="Remarks"></textarea>
            </div>
