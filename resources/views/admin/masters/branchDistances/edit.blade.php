            ...
            <div class="row">
                ...
                <div class="col-xl-10 col-md-10 col-lg-10">
                    <div class="card">
                        ...
                        <div class="card-body">
                            {!! Form::open(['action' => ['admin\masters\DesignationsController@update', $designation->id], 'method' => 'POST']) !!}
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="form-label">Select Department<span class="text-red">*</span>:</label>
                                            {{Form::select('departmentId', $departments, $designation->departmentId, ['class'=>'form-control', 'id'=>'departmentId', 'required'])}}
                                        </div>
                                    </div>      
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="form-label">Designation Name<span class="text-red">*</span>:</label>
                                            <input type="text" class="form-control" name="name" value="{{$designation->name}}" placeholder="Designation Name">
                                        </div>
                                    </div>                                                
                                </div>
