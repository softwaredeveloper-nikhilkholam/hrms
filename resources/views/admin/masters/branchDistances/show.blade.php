                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="name" value="{{$designation->departmentName}}" placeholder="Designation Name" readonly>
                                        </div>
                                    </div>      
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="form-label">Designation Name:</label>
                                            <input type="text" class="form-control" name="name" value="{{$designation->name}}" placeholder="Designation Name" readonly>
                                        </div>
                                    </div>                                       
                                </div> 
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" value="{{$util->dateFormat($designation->created_at,2)}}" name="name" readonly>
                                        </div>
                                    </div>   
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="form-label">Updated By:</label>
                                            <input type="text" class="form-control" value="{{$designation->updated_by}}" name="name" readonly>
                                        </div>
                                    </div>                                   
                                </div>                                   
