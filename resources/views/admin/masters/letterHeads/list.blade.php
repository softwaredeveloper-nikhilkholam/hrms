                                            ...
                                            <tbody>
                                                @foreach($letterHeads as $letter)
                                                    <tr>
                                                        <td>{{$i++}}</td>
                                                        <td>{{$letter->name}}</td>
                                                        <td><img src="admin/letterHeads/{{$letter->fileName}}" height="100px" width="120px"></td>
                                                        <td>
                                                            <a href="/letterHeads/{{$letter->id}}/edit" class="btn btn-primary btn-icon btn-sm">
                                                                <i class="fa fa-edit" style="font-size:20px;" data-toggle="tooltip" data-original-title="Edit"></i>
                                                            </a>
                                                            <a href="/letterHeads/{{$letter->id}}/deactivate" class="btn btn-danger btn-icon btn-sm" onclick="return confirm('Are you sure?')">
