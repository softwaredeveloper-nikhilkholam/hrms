                                                        ...
                                                        @foreach($lapAssets as $asset)
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <a href="/assets/1/{{$asset->id}}/deactivate" class="btn btn-danger btn-icon btn-sm" onclick="return confirm('Are you sure?')">
                                                                        <i class="fa fa-times-circle-o" style="font-size:20px;" aria-hidden="true"data-toggle="tooltip" data-original-title="Dedeactivate"></i>
                                                                    </a>
                                                        ...
                                                        @foreach($deskAssets as $asset)
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <a href="/assets/5/{{$asset->id}}/deactivate" class="btn btn-danger btn-icon btn-sm" onclick="return confirm('Are you sure?')">
                                                                        <i class="fa fa-times-circle-o" style="font-size:20px;" aria-hidden="true"data-toggle="tooltip" data-original-title="Dedeactivate"></i>
                                                                    </a>
                                                        ...
                                                        @foreach($mobAssets as $asset)
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <a href="/assets/2/{{$asset->id}}/deactivate" class="btn btn-danger btn-icon btn-sm" onclick="return confirm('Are you sure?')">
                                                                        <i class="fa fa-times-circle-o" style="font-size:20px;" aria-hidden="true"data-toggle="tooltip" data-original-title="Dedeactivate"></i>
                                                                    </a>
                                                        ...
                                                        @foreach($simAssets as $asset)
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <a href="/assets/3/{{$asset->id}}/deactivate" class="btn btn-danger btn-icon btn-sm" onclick="return confirm('Are you sure?')">
                                                                        <i class="fa fa-times-circle-o" style="font-size:20px;" aria-hidden="true"data-toggle="tooltip" data-original-title="Dedeactivate"></i>
                                                                    </a>
                                                        ...
                                                        @foreach($pendAssets as $asset)
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <a href="/assets/4/{{$asset->id}}/deactivate" class="btn btn-danger btn-icon btn-sm" onclick="return confirm('Are you sure?')">
                                                                        <i class="fa fa-times-circle-o" style="font-size:20px;" aria-hidden="true"data-toggle="tooltip" data-original-title="Dedeactivate"></i>
                                                                    </a>
                                                        ...
                                                        @foreach($hardAssets as $asset)
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <a href="/assets/6/{{$asset->id}}/deactivate" class="btn btn-danger btn-icon btn-sm" onclick="return confirm('Are you sure?')">
                                                                        <i class="fa fa-times-circle-o" style="font-size:20px;" aria-hidden="true"data-toggle="tooltip" data-original-title="Dedeactivate"></i>
                                                                    </a>
