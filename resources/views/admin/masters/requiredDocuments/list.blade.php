                ...
                <div class="col-xl-12 col-md-12 col-lg-12">
                    <div class="card">
                        <div class="card-header  border-0">
                            <h4 class="card-title">Active Required Documents</h4>
                        </div>
                        <div class="card-body">
                                        ...
                                        <table class="table  table-vcenter text-nowrap table-bordered border-top" id="hr-table">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="border-bottom-0">Desigation Name</th>
                                            ...
                                            <tbody>
                                                @foreach($requiredDocuments as $requiredDocument)
                                                    <tr>
                                                        <td>{{$i++}}</td>
                                                        <td>{{$requiredDocument->departmentName}}</td>
                                                        <td>{{$requiredDocument->designationName}}</td>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="/requiredDocuments/{{$requiredDocument->id}}/deactivate" class="btn btn-danger btn-icon btn-sm" onclick="return confirm('Are you sure?')">
