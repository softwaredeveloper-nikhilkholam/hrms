                ...
                <div class="col-xl-10 col-md-10 col-lg-10">
                    <div class="card">
                        <div class="card-header  border-0">
                            <h4 class="card-title">Deactive Branch Summary</h4>
                        </div>
                        <div class="card-body">
                            @if(isset($branches))
                                @if(count($branches) >= 1)
                                                ...
                                                @foreach($branches as $branch)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="/branches/{{$branch->id}}/activate" class="btn btn-danger btn-icon btn-sm" onclick="return confirm('Are you sure?')">
