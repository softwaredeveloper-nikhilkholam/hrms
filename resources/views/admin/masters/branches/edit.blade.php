            ...
            <div class="row">
                ...
                <div class="col-xl-10 col-md-10 col-lg-10">
                    <div class="card">
                        ...
                        <div class="card-body">
                            {!! Form::open(['action' => ['admin\masters\BranchesController@update', $branch->id], 'method' => 'POST']) !!}
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="form-label">Branch Name<span class="text-red">*</span>:</label>
                                            <input type="text" class="form-control" value="{{$branch->name}}" name="name" placeholder="Branch Name" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="form-label">Email<span class="text-red">*</span>:</label>
                                            <input type="email" class="form-control" value="{{$branch->email}}" name="email" placeholder="Email" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control mb-4" placeholder="Textarea" rows="3" maxlength="3000" name="address" placeholder="Branch Address" required>{{$branch->address}}</textarea>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            {{Form::select('regionId', $regions, $branch->regionId, ['class'=>'form-control', 'placeholder'=>'Select State', 'id'=>'regionId', 'required'])}}
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            {{Form::select('cityId', $cities, $branch->cityId, ['class'=>'form-control', 'id'=>'cityId', 'required'])}}
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="form-label">PIN Code<span class="text-red">*</span> :</label>
                                            <input type="text" class="form-control" value="{{$branch->PINCode}}" name="PINCode" placeholder="PIN Code" required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" value="{{$branch->contactNo1}}"  name="contactNo1" placeholder="Contact No 1" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="form-label">Contact No 2:</label>
                                            <input type="text" class="form-control" value="{{$branch->contactNo2}}" name="contactNo2" placeholder="Contact No 2">
                                        </div>
                                    </div>
                                </div>
