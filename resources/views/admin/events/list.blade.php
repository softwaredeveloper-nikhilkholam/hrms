                ...
                <div class="col-xl-12 col-md-12 col-lg-12">
                    <div class="card">
                        <div class="card-header  border-0">
                            <h4 class="card-title">Active Event</h4>
                        </div>
                        <div class="card-body">
                            @if(isset($events))
                                @if(count($events) >= 1)
                                            ...
                                            <tbody>
                                                @foreach($events as $event)
                                                    <tr>
                                                        ...
                                                        <td>{{date('d-m-Y', strtotime($event->forDate))}}</td>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="/events/{{$event->id}}/deactivate" class="btn btn-danger btn-icon btn-sm" onclick="return confirm('Are you sure?')">
