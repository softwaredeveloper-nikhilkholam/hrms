                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="title"  value="{{$event->title}}" id="empName" placeholder="Event Title" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="description"    value="{{$event->description}}" id="description" maxlength="2000" placeholder="Event Description" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" value="{{$event->forDate}}" name="forDate" min="{{date('Y-m-d')}}" placeholder="dd-mm-yyyy" required>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            {{Form::select('branchId', $branches, $event->branchId, ['placeholder'=>'Select Branch','class'=>'branchId form-control', 'id'=>'branchId', 'required'])}}
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            {{Form::select('section', ['Teaching'=>'Teaching', 'Non Teaching'=>'Non Teaching'], $event->section, ['placeholder'=>'Select Section','class'=>'sectionId form-control'])}}
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            {{Form::select('designationId', $designations, $event->designationId, ['placeholder'=>'Select Designation','class'=>'empDesignationId form-control', 'id'=>'designationId'])}}
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
