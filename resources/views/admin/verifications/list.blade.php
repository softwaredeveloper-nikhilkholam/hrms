            ...
            <div class="page-header d-xl-flex d-block">
                ...
                <div class="page-rightheader ml-md-auto">
                    <div class="align-items-end flex-wrap my-auto right-content breadcrumb-right">
                        <div class="btn-list">
                            <a href="#" class="btn btn-success mr-3">Selected List</a>
                            <a href="/jobApplications/verifiedList" class="btn btn-primary mr-3">Verified List</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-xl-12 col-md-12 col-lg-12">
                    <div class="card">
                        <div class="card-header  border-0">
                            <h4 class="card-title">Selected Employee List [<b style="color:red;">{{count($candidates)}}</b>]</h4>
                        </div>
                        <div class="card-body">
                            @if(isset($candidates))
                                @if(count($candidates))
                                        ...
                                        <table class="table table-vcenter text-nowrap table-bordered border-top border-bottom" id="hr-table">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="border-bottom-0" width="10%">Contact No<?php $i=1; ?></th>
                                            ...
                                            <tbody>
                                                @foreach($candidates as $row)
                                                    <tr>
                                                        ...
                                                        <td>{{$row->phoneNo}}</td>
                                                        <td>
                                                            <a href="/jobApplications/showDetails/{{$row->id}}/1" class="btn btn-danger btn-icon btn-sm">
