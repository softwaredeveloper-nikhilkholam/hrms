                ...
                <div class="page-header d-xl-flex d-block">
                    ...
                    <div class="page-rightheader ml-md-auto">
                        <div class="align-items-end flex-wrap my-auto right-content breadcrumb-right">
                            <div class="btn-list">
                                <a href="/appointments/requestList" class="btn btn-primary mr-3">Current List</a>
                                    ...
                                    <div class="row">
                                        <div class="col-md-2 col-lg-2">
                                            <div class="form-group">
                                                ...
                                                <input type="date" name="forDate" class="form-control" value="{{((isset($forDate))?$forDate:date('Y-m-d'))}}">
                                            </div>
                                        </div>
                                        @if($userType == "51")
                                            <div class="col-md-2 col-lg-2">
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <div class="row" style="margin-top:15px;">
                                                ...
                                                <div class='col-md-2'>
                                                    ...
                                                    <a href="/appointments/exportExcel" class="btn btn-danger mt-2"><span class="icons"><i class="ri-download-2-line"></i></span> Download Excel <i class="fa fa-file-excel-o" aria-hidden="true"></i></a>
                                                </a>
                                            </div>
                                        </div>
                                    @else
