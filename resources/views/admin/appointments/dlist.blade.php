            ...
            <div class="page-header d-xl-flex d-block">
                ...
                <div class="page-rightheader ml-md-auto">
                    <div class="align-items-end flex-wrap my-auto right-content breadcrumb-right">
                        <div class="btn-list">
                            <a href="/empAdvRs" class="btn btn-success mr-3">Active List</a>
                ...
                <div class="col-xl-12 col-md-12 col-lg-12">
                    <div class="card">
                        <div class="card-header  border-0">
                            <h4 class="card-title">Deactive Advance Entry</h4>
                        </div>
                        <div class="card-body">
                            @if(isset($empAdvs))
                                @if(count($empAdvs) >= 1)
                                        ...
                                        <table class="table  table-vcenter text-nowrap table-bordered border-top border-bottom" id="hr-table">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="border-bottom-0"  width="10%">Amount</th>
                                                    <th class="border-bottom-0" width="10%">Deduction</th>
                                            ...
                                            <tbody>
                                                @foreach($empAdvs as $empAdv)
                                                    <tr>
                                                        ...
                                                        <td>{{$empAdv->empCode}}</td>
                                                        <td>{{$empAdv->empName}}</td>
                                                        <td>{{$empAdv->amount}}</td>
                                                        <td>{{$empAdv->deduction}}</td>
                                                        <td>{{$empAdv->status}}</td>
                                                        <td>
