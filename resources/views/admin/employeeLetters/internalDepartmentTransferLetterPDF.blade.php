                        ...
                        <td>
                            ...
                            <div class="row">
                                <div class="col-md-12" style="margin-top:30px;margin-left:20px;">
                                    This is to inform you that your services are being transferred from <b>{{$empDet->departmentName}}</b> to <b>{{$newDepartment}} ( {{$newDesignation}} )</b> w.e.f. <b>{{date('d-m-Y', strtotime($forDate))}}</b>.
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12" style="margin-top:30px;margin-left:20px;">
