                        ...
                        <td>
                            ...
                            <div class="row">
                                <div class="col-md-12" style="margin-top:30px;margin-left:20px;">
                                    This is to inform you that your services are being transferred from <b>{{$empDet->branchName}}</b> to <b>{{$newBranch}}</b> w.e.f. <b>{{date('d-m-Y', strtotime($forDate))}}</b>.
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12" style="margin-top:30px;margin-left:20px;">
                                    Your work profile from new branch will be handed over to you soon and you will report to Head of the Department.
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12" style="margin-top:30px;margin-left:20px;">
                                    Your salary will remain the same and all other terms &amp; conditions of your service will remain unchanged.
                                </div>
                            </div>
