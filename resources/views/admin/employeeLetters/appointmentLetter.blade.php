        ...
        <div class="side-app">        
            ...
            <div class="page-header d-xl-flex d-block">
                <div class="page-leftheader">
                    <h4 class="page-title">Employee Appointment Letter</h4>
                </div>
                ...
                <div class="col-xl-12 col-md-12 col-lg-12">
                    <div class="card">
                        <div class="card-header border-0">
                            <h4 class="card-title">Employee Appointment Letter</h4>
                        </div>
                        <div class="card-body">
                            {!! Form::open(['action' => 'admin\EmployeeLettersController@getAppointmentLetter', 'method' => 'GET', 'class' => 'form-horizontal']) !!}
                                <div class="row">
                                    <div class="col-md-4">
                            ...
                            <hr>
                            @if(isset($empDet))
                                {!! Form::open(['action' => 'admin\EmployeeLettersController@generateAppointment', 'method' => 'POST', 'class' => 'form-horizontal']) !!}
                                <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            {{Form::select('organisation', ['1'=>'Ellora Medicals and Educational foundation', '2'=>'Snayraa Agency', '3'=>'Tejasha Educational and research foundation'], $empDet->organisation, ['placeholder'=>'Select Organisation','class'=>'form-control', 'id'=>'organisation', 'required'])}}
                                        </div>
                                    </div> 
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="form-label">From &nbsp;<span class="text-red" style="font-size:22px;">*</span> &nbsp;<span class="text-red" style="font-size:22px;"></span>:</label>
                                            <input type="date" class="form-control" name="fromDate"  value="{{date('Y-m-d', strtotime('+2 month', strtotime($empDet->jobJoingDate)))}}" id="appointmentFromDate" placeholder="Joining Date" required>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="form-label">To &nbsp;<span class="text-red" style="font-size:22px;">*</span> &nbsp;<span class="text-red" style="font-size:22px;"></span>:</label>
                                            <input type="date" class="form-control" name="toDate"  value="{{date('Y-m-d', strtotime('+1 year', strtotime($empDet->jobJoingDate)))}}" id="appointmentToDate" placeholder="Joining Date" required>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" onkeypress="return /[0-9]/i.test(event.key)" class="form-control" name="salary"  value="" id="" placeholder="0" required>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="form-label">Appointment Period<span class="text-red" style="font-size:22px;">*</span> &nbsp;<span class="text-red" style="font-size:22px;"></span>:</label>
                                            {{Form::select('aPeriod', ['Purely Temporary'=>'Purely Temporary','Probation Period'=>'Probation Period','Academic Year'=>'Academic Year','Leave Vacancy'=>'Leave Vacancy'],null, ['placeholder'=>'Select Appointment Period','class'=>'form-control', 'id'=>'signBy', 'required'])}}
                                        </div>
                                    </div> 
                                    <div class="col-md-4">
                                        <div class="form-group">
                                ...
                                <div class="row" style="margin-top:10px;">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <input type="Submit" name="submit" value="Download Appointment Letter" class="empAdd btn btn-primary btn-lg">
                                        <input type="Submit" name="submit" value="Save Appointment Letter" style="background-color:seagreen;color:white;" class="btn btn-lg">
                                        <a href="/employeeLetters/list/2" class="btn btn-danger btn-lg">Cancel</a>
                                    </div>
                                    <div class="col-md-2"></div>
                                </div>
                                {!! Form::close() !!} 
