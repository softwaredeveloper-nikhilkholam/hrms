                ...
                <div class="col-xl-10 col-md-10 col-lg-10">
                    <div class="card">
                        <div class="card-header  border-0">
                            <h4 class="card-title">Edit Signature File</h4>
                        </div>
                        <div class="card-body">
                            {!! Form::open(['action' => ['admin\SignatureFilesController@update', $signFile->id], 'method' => 'POST', 'enctype'=>'multipart/form-data']) !!}
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="form-label">Signature Name<span class="text-red">*</span>:</label>
                                            <input type="text" class="form-control" name="name" value="{{$signFile->name}}" placeholder="Signature Name">
                                        </div> 
                                    </div>   
                                    <div class="col-md-6">
                                        <div class="form-group">
