            ...
            <div class="page-header d-xl-flex d-block">
                ...
                <div class="page-rightheader ml-md-auto">
                    <div class="align-items-end flex-wrap my-auto right-content breadcrumb-right">
                        <div class="btn-list">
                            <a href="/signFiles" class="btn btn-success mr-3">Active List</a>
                ...
                <div class="col-xl-10 col-md-10 col-lg-10">
                    <div class="card">
                        <div class="card-header  border-0">
                            <h4 class="card-title">Deactive Signature</h4>
                        </div>
                        <div class="card-body">
                            @if(isset($signFiles))
                                                ...
                                                @foreach($signFiles as $file)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="/signFiles/{{$file->id}}/activate" class="btn btn-danger btn-icon btn-sm" onclick="return confirm('Are you sure?')">
                                                                <i class="fa fa-times-check" style="font-size:20px;" aria-hidden="true"data-toggle="tooltip" data-original-title="Activate"></i>
                                                            </a>
                                                        </td>
                                                    </tr>
                                                @endforeach                                        
