                ...
                <div class="page-rightheader ml-md-auto">
                    <div class="align-items-end flex-wrap my-auto right-content breadcrumb-right">
                        <div class="btn-list">
                            ...
                            <a href="/notices/create" class="btn btn-success mr-3">Add</a>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label class="form-label" style="font-size:14px !important;">Branches:</label>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label class="form-label" style="font-size:14px !important;">Section:</label>
                                        <div class="font-weight-bold"  style="font-size:14px !important;"></div>
                                    </div>
                                </div>                                      
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label class="form-label" style="font-size:14px !important;">Title:<span class="text-red">*</span>:</label>
                                        <div class="font-weight-bold"  style="font-size:14px !important;"></div>
                                    </div>
                                </div> 
                            </div> 
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="form-label" style="font-size:14px !important;">Discription:<span class="text-red">*</span>:</label>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-12 col-lg-3">
                                        <a href="/notices/create" class="btn btn-warning btn-lg">
