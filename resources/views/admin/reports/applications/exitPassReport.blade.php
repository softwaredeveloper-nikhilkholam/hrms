	...
	<div class="container">                        
        ...
        <div class="page-header d-xl-flex d-block">
            <div class="page-leftheader">
                <h4 class="page-title">Exit Pass Report</h4>
            </div> 
        </div>
        <!--End Page header-->
        <div class="row">
            <div class="col-xl-12 col-md-12 col-lg-12">
                <div class="card">
                    <div class="card-body">
                        {!! Form::open(['action' => 'admin\ReportsController@exitPassReport', 'method' => 'GET', 'class' => 'form-horizontal']) !!}
                            <div class="row mt-5">
                                        ...
                                        <tbody>
                                            @foreach($exitPassApplications as $app)
                                                <tr>
                                                    ...
                                                    <td>{{$app->totalCt}}</td>
                                                    <td>
                                                        <a href="/reports/{{$app->empId}}/{{$app->forDateYear.'-'.$app->forDateMonth}}/2/viewMore" class="btn btn-success btn-icon btn-sm">
