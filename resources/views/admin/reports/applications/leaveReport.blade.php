	...
	<div class="container">                        
        ...
        <div class="row">
            <div class="col-xl-12 col-md-12 col-lg-12">
                <div class="card">
                    <div class="card-body">
                        {!! Form::open(['action' => 'admin\ReportsController@leaveReport', 'method' => 'GET', 'class' => 'form-horizontal']) !!}
                            <div class="row mt-5">
                                        ...
                                        <tbody>
                                            @foreach($applications as $app)
                                                <tr>
                                                    ...
                                                    <td>{{$app->totalCt}}</td>
                                                    <td>
                                                        <a href="/reports/{{$app->empId}}/{{$app->forDateYear.'-'.$app->forDateMonth}}/3/viewMore" class="btn btn-success btn-icon btn-sm">
