	...
	<div class="container">                        
        ...
        <div class="page-header d-xl-flex d-block">
            <div class="page-leftheader">
                <h4 class="page-title">Travelling Allowance Report</h4>
            </div> 
        </div>
        <!--End Page header-->
        <div class="row">
            <div class="col-xl-12 col-md-12 col-lg-12">
                <div class="card">
                    <div class="card-body">
                        {!! Form::open(['action' => 'admin\ReportsController@travellingAllowReport', 'method' => 'GET', 'class' => 'form-horizontal']) !!}
                            <div class="row mt-5">
                    ...
                    <div class="card-body">
                        @if(isset($travellingApplications))
                            @if(count($travellingApplications) >= 1)
                                <div class="table-responsive">
                                    <table class="table table-striped card-table table-vcenter text-nowrap mb-0 " id="example">
                                        ...
                                        <tbody>
                                            @foreach($travellingApplications as $app)
                                                <tr>
                                                    <td>{{$i++}}</td>
                                                    <td>
                                                            @if($app->firmType == 1)
