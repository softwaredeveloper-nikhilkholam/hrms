        ...
        <div class="side-app">        
                ...
                <div class="page-rightheader ml-md-auto">
                    <div class="align-items-end flex-wrap my-auto right-content breadcrumb-right">
                        <div class="btn-list">
                            ...
                            <a href="#" class="btn btn-success mr-3">Edit Entry</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-xl-12 col-md-12 col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            {!! Form::open(['action' => 'admin\recruitments\JobApplicationsController@interviewDUpdate', 'method' => 'POST', 'class' => 'form-horizontal']) !!}
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="form-label">Drive Start Date<span class="text-red">*</span>:</label>
                                            <input type="date" class="form-control" name="startDate" value="{{$application->startDate}}" placeholder="" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" name="endDate" value="{{$application->endDate}}" placeholder="" required>
                                        </div>
                                    </div>  
                                </div> 
                                <div class="row">
