        ...
        <div class="side-app">        
            <div class="page-header d-xl-flex d-block">
                <div class="page-leftheader">
                    <h4 class="page-title">Interview Drive</h4>
                </div>
                <div class="page-rightheader ml-md-auto">
                    <div class="align-items-end flex-wrap my-auto right-content breadcrumb-right">
                        <div class="btn-list">
                            <a href="/jobApplications/interviewDList" class="btn btn-primary mr-3">Interview Drive List</a>
                            <a href="#" class="btn btn-success mr-3">Add Entry</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-xl-12 col-md-12 col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            {!! Form::open(['action' => 'admin\recruitments\JobApplicationsController@interviewDStore', 'method' => 'POST', 'class' => 'form-horizontal']) !!}
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="form-label">Drive Start Date<span class="text-red">*</span>:</label>
                                            <input type="date" class="form-control" name="startDate" value="{{date('Y-m-d')}}" placeholder="" required>
                                        </div>
                                    </div>
                                    <div class="col-md-4"></div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="form-label">Drive End Date<span class="text-red">*</span>:</label>
                                            <input type="date" class="form-control" name="endDate" value="{{date('Y-m-d')}}" placeholder="" required>
                                        </div>
                                    </div>  
                                </div> 
                                <div class="row">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 col-lg-3">
                                            <input type="hidden" value="2" name="appType">
