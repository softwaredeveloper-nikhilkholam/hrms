            ...
            <div class="page-header d-xl-flex d-block">
                ...
                <div class="page-rightheader ml-md-auto">
                    <div class="align-items-end flex-wrap my-auto right-content breadcrumb-right">
                        <div class="btn-list">
                            <a href="#" class="btn btn-success mr-3">Interview Drive2 List</a>
                            <a href="/jobApplications/interviewDCreate" class="btn btn-primary mr-3">Add Entry</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-xl-12 col-md-12 col-lg-12">
                    <div class="card">
                        <div class="card-header  border-0">
                            <h4 class="card-title">Interview Drive List</h4>
                        </div>
                        <div class="card-body">
                                            ...
                                            <tbody>
                                                @foreach($applications as $app)
                                                    <tr>
                                                        ...
                                                        <td>{{$app->appStatus}}</td>
                                                        <td>
                                                            <a href="/jobApplications/interviewDShow/{{$app->id}}" class="btn btn-success btn-icon btn-sm">
                                                                <i class="fa fa-eye" style="font-size:20px;" data-toggle="tooltip" data-original-title="View"></i>
                                                            </a>
                                                            <a href="/jobApplications/interviewDEdit/{{$app->id}}" class="btn btn-primary btn-icon btn-sm">
