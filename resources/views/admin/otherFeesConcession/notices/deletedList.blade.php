                ...
                <div class="page-rightheader ml-md-auto">
                    <div class="align-items-end flex-wrap my-auto right-content breadcrumb-right">
                        <div class="btn-list">
                            ...
                            <a href="/notices/deletedList" class="btn btn-dangerdanger mr-3">Deleted List</a>
                ...
                <div class="col-xl-12 col-md-12 col-lg-12">
                    <div class="card">
                        <div class="card-header  border-0">
                            <h4 class="card-title">Archive Board Notice</h4>
                        </div>
                        <div class="card-body">
                            @if(isset($notices))
                                @if(count($notices) >= 1)
                                                ...
                                                @foreach($notices as $row)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="/notices/{{$row->id}}/activate" class="btn btn-danger btn-icon btn-sm" onclick="return confirm('Are you sure?')">
                                                                <i class="fa fa-times-circle-o" style="font-size:20px;" aria-hidden="true"data-toggle="tooltip" data-original-title="activated"></i>
                                                            </a>
                                                        </td>
                                                    </tr>
                                                @endforeach                                        
                                ...
                                @else
                                    <h4 style="color:red;">Not Found Deleted Records.</h4>
                                @endif
                            @endif
                        </div>
                    </div>
