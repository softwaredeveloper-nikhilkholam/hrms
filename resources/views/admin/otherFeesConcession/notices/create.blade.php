                ...
                <div class="page-rightheader ml-md-auto">
                    <div class="align-items-end flex-wrap my-auto right-content breadcrumb-right">
                        <div class="btn-list">
                            ...
                            <a href="#" class="btn btn-success mr-3">Add Board Notice</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-xl-12 col-md-12 col-lg-12">
                    <div class="card">
                        <div class="card-header  border-0">
                            <h4 class="card-title">Add Board Notice</h4>
                        </div>
                        <div class="card-body">
                            {!! Form::open(['action' => 'admin\NoticesController@store', 'method' => 'POST', 'class' => 'form-horizontal']) !!}
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label class="form-label">Select Branch:</label>
                                            {{Form::select('branchId', $branches, NULL, ['placeholder'=>'Select Branch','class'=>'branchId form-control', 'id'=>'branchId'])}}
                                        </div>
                                    </div>  
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label class="form-label">Select Departments:</label>
                                            {{Form::select('departmentId[]', $departments, NULL, ['placeholder'=>'Select Department','class'=>'noticeDepartmentId form-control', 'id'=>'departmentId', "multiple"=>"multiple"])}}
                                        </div>
                                    </div> 
                                    <div class="col-md-3">
                                        <div class="form-group">
                                ...
                                <div class="row"> 
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="description" placeholder="Notice Board" cols="10" required></textarea>
                                        </div>
                                    </div>                                  
                                </div>   
                                <div class="form-group">
