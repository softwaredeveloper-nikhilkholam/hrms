        ...
        <div class="side-app">        
            <div class="page-header d-xl-flex d-block">
                <div class="page-leftheader">
                    <h4 class="page-title">Active List</h4>
                </div>
                <div class="page-rightheader ml-md-auto">
                    <div class="align-items-end flex-wrap my-auto right-content breadcrumb-right">
                        <div class="btn-list">
                            <a href="/projectCredentials/create" class="btn btn-primary mr-3">Add</a>
                ...
                <div class="col-xl-12 col-md-12 col-lg-12">
                    <div class="card">
                        <div class="card-header  border-0">
                            <div class='col-md-7'><h4 class="card-title">Project Credentials List</h4></div>
                        </div>
                        <div class="card-body">
                                        ...
                                        <table class="table card-table table-vcenter text-nowrap table-primary mb-0" id="example">
                                            ...
                                            <tbody>
                                                    <tr>
                                                        ...
                                                        <td>Test</td>
                                                        <td>
                                                            <a href="/projectCredentials/create" class="btn btn-primary btn-icon btn-sm">
                                                            ...
                                                            <a href="/projectCredentials/show" class="btn btn-success btn-icon btn-sm">
