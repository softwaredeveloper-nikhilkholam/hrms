    ...
    <div class="container">                        
      <div class="page-header d-xl-flex d-block">
          ...
          <div class="page-rightheader">
              <div class="row">
                  <h4 class="page-title"><a class="btn btn-primary" href="/Module/list">Active List</a></h4>&nbsp;&nbsp;
                  <h4 class="page-title"><a class="btn btn-primary" href="/Module/dList">Deactive List</a></h4>&nbsp;&nbsp;
              </div> 
