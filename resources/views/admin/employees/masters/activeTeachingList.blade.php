        ...
        <div class="side-app">
            <div class="page-header d-xl-flex d-block">
                <div class="page-leftheader">
                     <h4 class="page-title"><i class="fas fa-users"></i>Teaching Employees</h4>
                </div>
                <div class="page-rightheader ml-auto">
                    ...
                    <a href="/employees/teachingEmps" class="btn btn-danger">Teaching</a>
                </div>
            </div>
                            ...
                            @if(isset($employees) && count($employees) >= 1)
                                ...
                                @if(!isset($search))
                                    <div class="d-flex justify-content-end mt-3">
                                        <a href="/employees/exportempExcel/{{(isset($search))?$search:0}}/1/Teaching" class="btn btn-danger"><i class="fas fa-file-excel mr-2"></i>Download Excel</a>
                                    </div>
                                @endif
                            @else
