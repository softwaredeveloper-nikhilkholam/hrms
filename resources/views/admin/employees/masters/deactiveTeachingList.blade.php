        ...
        <div class="side-app">        
            <div class="page-header d-xl-flex d-block">
                <div class="page-leftheader">
                    <h4 class="page-title">Teaching Employees</h4>
                </div>
            </div>
            <!--End Page header-->
                ...
                <div class="col-xl-12 col-md-12 col-lg-12">
                    <div class="card">
                        <div class="card-header  border-0">
                            <div class='col-md-7'><h4 class="card-title">Deactive Teaching Employees</h4></div>
                        </div>
                        <div class="card-body">
                            @if(isset($employees))
                                @if(count($employees) >= 1)
                                    ...
                                    @if(!isset($search))
                                        <div class="row" style="margin-top:15px;">
                                            ...
                                            <div class='col-md-2'>
                                                <a href="/employees/exportempExcel/{{(isset($search))?$search:0}}/0/Teaching" class="btn btn-danger mt-2"><span class="icons"><i class="ri-download-2-line"></i></span> Download Excel <i class="fa fa-file-excel-o" aria-hidden="true"></i></a>
                                            </div>
                                        </div>
                                    @endif
                                @else
