        ...
        <div class="side-app">        
            <div class="page-header d-xl-flex d-block">
                <div class="page-leftheader">
                    <h4 class="page-title">In-Active Non Teaching Employees</h4>
                </div>
            </div>
            <div class="row">
                                ...
                                @if(count($employees) >= 1)
                                                            ...
                                                            <a href="/employees/{{$employee->id}}">
                                                                <div class="d-flex">
                                                                    <div class="mr-3 mt-0 mt-sm-1 d-block">
                                                                        <h6 class="mb-1 fs-14">{{$employee->name}}&nbsp;&nbsp;
                                                                        </h6>
                                    ...
                                    @if(!isset($search))
                                        <div class="row" style="margin-top:15px;">
                                            ...
                                            <div class='col-md-2'>
                                                <a href="/employees/exportempExcel/{{(isset($search))?$search:0}}/2/Non Teaching" class="btn btn-danger mt-2"><span class="icons"><i class="ri-download-2-line"></i></span> Download Excel <i class="fa fa-file-excel-o" aria-hidden="true"></i></a>
                                            </div>
                                        </div>
                                    @endif
                                @else
