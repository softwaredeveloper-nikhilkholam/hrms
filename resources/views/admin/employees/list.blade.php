                ...
                <div class="col-xl-12 col-md-12 col-lg-12">
                    <div class="card">
                        <div class="card-header  border-0">
                            <div class='col-md-7'><h4 class="card-title">Active Employees</h4></div>
                        </div>
                        <div class="card-body">
                            @if(isset($employees))
                                        ...
                                        <table class="table card-table table-vcenter text-nowrap table-primary mb-0" id="example">
											<thead class="text-white" style="background-color:seagreen;">
                                                <tr>
                                                    ...
                                                    @endif
                                                    @if($userType == '51' || $userType == '61' || $userType == '71' || $userType == '81' || $userType == '91')
                                                            ...
                                                            <a href="/employees/{{$employee->id}}">
                                                                <div class="d-flex">
                                                                    <div class="mr-3 mt-0 mt-sm-1 d-block">
                                                                        ...
                                                                        @else
                                                                            <p class="text-muted mb-0 fs-12">{{$employee->departmentName}}</p>
                                                                        @endif
                                                                    </div>
                                                                </div>
                                                            </a>
