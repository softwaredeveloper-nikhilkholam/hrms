                ...
                <div class="page-rightheader ml-md-auto">
                    <div class="align-items-end flex-wrap my-auto right-content breadcrumb-right">
                        <div class="btn-list">
                            ...
                            <a href="/empAttendances/salaryHoldDList" class="btn btn-success mr-3">Deactive List</a>
                                        ...
                                        <tbody>
                                            @foreach($lists as $list)
                                                <tr>
                                                    ...
                                                    <td style="color:<?php echo ($list->status == 0)?'green':'red'; ?>"><b>{{($list->status == 0)?'Release':'Hold'}}</b></td>
                                                    <td>{{date('d-M-Y H:i A', strtotime($list->updated_at))}}</td>
                                                    <td>
                                                        <a href="/empAttendances/{{$list->id}}/activeOrDeactiveSalaryStatus" class="btn btn-success"><i class="fa fa-check"></i></a>
                                                    </td>
                                                </tr>
                                            @endforeach
                                        </tbody>
