                ...
                <div class="page-rightheader ml-md-auto">
                    <div class="align-items-end flex-wrap my-auto right-content breadcrumb-right">
                        <div class="btn-list">
                            ...
                            <a href="#" class="btn btn-success mr-3">Add Advance Entry</a>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card-body">
                            {!! Form::open(['action' => 'admin\employees\EmpAdvRsController@create', 'method' => 'GET', 'class' => 'form-horizontal']) !!}
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <input type="month" class="form-control" name="month" placeholder="Employee Month">
                                    </div>
                                    <div class="col-md-3">
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="amount" id="advAmount" placeholder="Advance Amount" required>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                    ...
                                    @else
                                        <div class="row">
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label class="form-label">Advance Amount&nbsp;<span class="text-red" style="font-size:22px;">*</span> &nbsp;<span class="text-red" style="font-size:22px;"></span>:</label>
                                                    <input type="text" class="form-control" name="deduction" id="advAmount" placeholder="Advance Amount" required>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label class="form-label">Deduction Month &nbsp;<span class="text-red" style="font-size:22px;">*</span> &nbsp;<span class="text-red" style="font-size:22px;"></span>:</label>
                                                    <input type="month" class="form-control" value="{{$month}}" name="month" id="" placeholder="Date of Deduction" required>
                                                </div>
                                            </div>
                                        </div>
                                    @endif
