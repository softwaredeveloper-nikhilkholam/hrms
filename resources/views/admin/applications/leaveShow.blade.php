        ...
        <div class="side-app">        
            ...
            <div class="page-header d-xl-flex d-block">
                <div class="page-leftheader">
                    <h4 class="page-title">Leave Application Details List</h4>
                </div>
                                        ...
                                        <table id="travelAllowTable" class="table  table-vcenter table-bordered border-top border-bottom travelAllowTable">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="" width="10%">Reason<?php $i=1;?></th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                {!! Form::open(['action' => 'admin\employees\EmpApplicationsController@changeLeaveStatus', 'method' => 'GET', 'class' => 'form-horizontal']) !!}
                                                    @foreach($applications as $row)
                                                        <tr>
                                                            <td>{{$i++}}</td>
                                                            <td>{{date('d-M', strtotime($row->startDate))}} To {{date('d-M', strtotime($row->endDate))}}</td>
                                                            <td>{{$row->reason}}<br>
                                                            {{($row->leaveType == 1)?'Full Day Leave':(($row->leaveType == 2)?'Half Day Leave( 1st Half )':'Half Day Leave( 2nd Half )')}}
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td colspan="8">
                                                            <center>
                                                                <button type="submit" name="" class="btn btn-danger btn-lg">Submit</button>
