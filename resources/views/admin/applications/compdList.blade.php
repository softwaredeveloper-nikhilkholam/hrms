	...
	<div class="container">                        
        ...
        <div class="page-header d-xl-flex d-block">
            <div class="page-leftheader">
                <h4 class="page-title">Deactive Compoff List</h4>
            </div> 
            <div class="page-rightheader">
                <div class="row">
                    <h4 class="page-title"><a class="btn btn-primary" href="/empApplications/applyCompoff">Apply Compoff</a></h4>&nbsp;&nbsp;
                            ...
                            <div class="row mt-5">
                                <div class="col-md-3 col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <input type='month' value="" class="form-control" name="month" id="month"/>
                                    </div>
                                </div>
