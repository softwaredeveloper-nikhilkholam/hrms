	...
	<div class="container">                        
        ...
        <div class="page-header d-xl-flex d-block">
            ...
            <div class="page-rightheader">
                <h4 class="page-title"><a class="btn btn-primary" href="/empApplications/applyApplication/3">Apply Leave</a></h4>
            </div> 
        </div>
        <!--End Page header-->
        <div class="row">
            <div class="col-xl-12 col-md-12 col-lg-12">
                <div class="card">
                    <div class="card-body">
                        {!! Form::open(['action' => 'admin\employees\EmpApplicationsController@empLeaveList', 'method' => 'GET', 'class' => 'form-horizontal']) !!}
                            <div class="row mt-5">
