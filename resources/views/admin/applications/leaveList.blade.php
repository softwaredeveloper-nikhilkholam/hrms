	...
	<div class="container">                        
        ...
        <div class="page-header d-xl-flex d-block">
            <div class="page-leftheader">
                <h4 class="page-title">Employee Leave List</h4>
            </div> 
        </div>
        <!--End Page header-->
        <div class="row">
            <div class="col-xl-12 col-md-12 col-lg-12">
                <div class="card">
                    <div class="card-body">
                        {!! Form::open(['action' => 'admin\employees\EmpApplicationsController@leaveList', 'method' => 'GET', 'class' => 'form-horizontal']) !!}
                            <div class="row mt-5">
                                        ...
                                        <tbody>
                                            @foreach($applications as $app)
                                                <tr>
                                                    ...
                                                    <td>{{$app->totalCt}}</td>
                                                    <td>
                                                        <a href="/empApplications/{{$app->empId}}/{{$month}}/1/leaveShow" class="btn btn-success btn-icon btn-sm">
                                    ...
                                    <div class="btn-toolbar float-right mt-3">
                                        <div class="btn-group">
                                            ...
                                            <div class="dropdown-menu" role="menu">
                                              <a class="dropdown-item" href="/empApplications/{{$month}}/1/exportLeaveExcel"><i class="fa fa-file-excel-o" aria-hidden="true" style="color:green;"></i>&nbsp;&nbsp;Summary Report</a>
                                              <a class="dropdown-item" href="/empApplications/{{$month}}/2/exportLeaveExcel"><i class="fa fa-file-excel-o" aria-hidden="true" style="color:green;"></i>&nbsp;&nbsp;Detail Report</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
