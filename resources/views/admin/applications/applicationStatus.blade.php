                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="table-responsive">
                                        <table  style="font-size:20px;" class="table" width="100%" border="1px">
                                            ...
                                            <tr>
                                                <td class="text-center">{{$application->empCode}}</td>
                                                    ...
                                                    @if($type == 1)
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-3">
                                                                ...
                                                                {{Form::select('wfh', ['Yes'=>'Yes', 'No'=>'No'], $application->wfh, ['class'=>'form-control', 'placeholder'=>'Select a Option'])}}
                                                            </div>
                                                        </div>
                                                    @elseif($type == 2)
                                                        <div class="row">
                                            ...
                                            @if($userType == '51' || $userType == '21' || $userType == '11' || $userType == '501' || $userType == '201' || $userType == '401' || $userType == '601')
                                                <tr>
                                            ...
                                            @else
                                                <tr>
                                                    @if($application->status == 0)
                                                        <td class="text-center" colspan="4"><b style="color:purple;">Pending</td>
                                                    @elseif($application->status == 1)
                                                        <td class="text-center" colspan="4"><b style="color:green;">Approved</td>
                                                    @elseif($application->status == 2)
                                                        <td class="text-center" colspan="4"><b style="color:red;">Rejected</td>
                                                    @endif
                                                </tr>
                                            @endif
                                            @if(count($appHistory) >= 1)
                                                <tr>
                                                    <td class="text-center" colspan="4" style="color:purple;background-color:yellow;"><b>Status History</b></td>
                                                </tr>
