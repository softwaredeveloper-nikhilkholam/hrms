            ...
            ?>
                ...
                @if(isset($applications))
                    <table>
                        <tbody>
                            <tr>
                                <td style="font-size:12px;" width="3%"><b>No.</b></td>
                                <td style="font-size:12px;" width="5%"><b>Day</b></td>
                                ...
                                <td style="font-size:12px;" width="3%"><b>KM<?php $i=1;$totKM=0;$totRs=0;  ?></b></td>
                                <td style="font-size:12px;" width="4%"><b>Rs</b></td>
                                <td style="font-size:12px;" width="8%"><b>Reporting Authority</b></td>
                                @if($userType == '61')
                            ...
                            @foreach($applications as $row)
                                <tr  style="font-size:10px;">
                                    ...
                                    <td>{{($row->status1 == 1)?'Approved':(($row->status1 == '0')?'Pending':'Rejected')}}</td>
                                    @if($userType == '61')
