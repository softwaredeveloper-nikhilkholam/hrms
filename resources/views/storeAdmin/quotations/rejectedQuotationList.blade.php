    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <div class="col-lg-12">
                        <div class="d-flex flex-wrap align-items-center justify-content-between">
                            <div  class="col-lg-4"><b style="color:red;">Rejected / Cancelled Quotation List</b></div>
                            <div  class="col-lg-8 text-right">
                                ...
                                <a href="/quotation/rejectedQuotationList" class="btn mb-1 btn-success">Rejected List</a>
                ...
                <div class="card-body">
                    {!! Form::open(['action' => 'storeController\PurchaseTransactions@rejectedQuotationList', 'method' => 'GET', 'class' => 'form-horizontal']) !!}
                        <div class="row">
                            <div class="col-md-2">
