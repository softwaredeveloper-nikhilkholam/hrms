                ...
                <div class="card-header">
                    <div class="col-lg-12">
                        <div class="d-flex flex-wrap align-items-center justify-content-between">
                            <div  class="col-lg-4"><b style="color:red;">Save Quotation List</b></div>
                            <div  class="col-lg-8 text-right">
                                ...
                                <a href="#" class="btn mb-1 btn-success">Save List</a>
                            </div>
                        </div>
                    </div>
                </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="padding: 0px 17px !important;font-size:12px !important;text-align:center;">
                                                            <div class="d-flex align-items-center list-action">
                                                                ...
                                                                <a class="badge bg-primary mr-2" data-toggle="tooltip" data-placement="top" data-original-title="Edit Quotation"
                                                                href="/quotation/{{$quotation->commQuotNo}}/editQuotation"><i class="fa fa-edit mr-0"></i></a>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                @endif
