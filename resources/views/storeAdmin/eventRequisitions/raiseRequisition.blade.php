    ...
    <div class="card">
        <div class="card-header">
            <div class="d-flex flex-wrap align-items-center justify-content-between">
                ...
                <div  class="col-lg-6">
                    <a href="/eventRequisitions/create" class="btn mb-1 btn-success">Raise Requisition</a>
        ...
        <div class="card-body">
            {!! Form::open(['action' => 'storeController\EventRequisitionsController@store', 'method' => 'POST', 'class' => 'form-horizontal', 'enctype'=>'multipart/form-data']) !!}
                <div class="row">  
                    <div class="col-md-2">                      
                ...
                <table class="table"> 
                    <tr style="background-color:green;color:white;">
                        <td style="background-color:green;color:white;font-size:20px;">Store Product</td>
                        <td style="background-color:red;color:white;font-size:20px;">New Product</td>
                        <td style="background-color:blue;color:white;font-size:20px;">Rental Product</td>
                    </tr>     
                    <tr style="border: 1px solid;">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div style="margin-bottom: 0rem;" class="form-group mt-4">
                                                ...
                                                <button type="button" id="addEventRequisitionRow" class="btn btn-danger" style="font-size:15px !important;">+&nbsp;&nbsp;Add</button>
                                            </div>
                                        </div>
                                        <div class="col-md-8">
                        ...
                        <td  style="border: 1px solid;">
                            <div class="row">
                                <div class="col-md-12">
                                    <label style="font-size:12px !important;"><b>Enter Product Name<span style="color:red;">*</span></b></label>
                                    <input type="text" value=""  id="newProductId" placeholder="PRODUCT NAME" class="form-control">
                                </div> 
                                <div class="col-md-12">
                                    <div style="margin-bottom: 0rem;" class="form-group">
                                        <label style="font-size:12px !important;"><b>Enter Qty<span style="color:red;">*</span></b></label>
                                        <input type="text" value=""  id="newQty"  onkeypress="return isNumberKey(event)" placeholder="QUANTITY" class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div style="margin-bottom: 0rem;" class="form-group">
                                        <label style="font-size:12px !important;">Select Unit<span style="color:red;">*</span></b></label>
                                        {{Form::select('unitId', $units, null, ['class'=>'form-control', 'placeholder'=>'Select a Unit', 'id'=>'newUnitId'])}}
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div style="margin-bottom: 0rem;" class="form-group">
                                        <label style="font-size:12px !important;">Description</label>
                                        <input type="text" value=""  id="newDescription" placeholder="DESCRIPTION" class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div style="margin-bottom: 0rem;" class="form-group mt-4">
                                        <label style="font-size:12px !important;"></label>
                                        <button type="button" id="addNewProductRequisitionRow" class="btn btn-success" style="font-size:15px !important;">+&nbsp;&nbsp;Add</button>
                                    </div>
                                </div>
                            </div>      
                        </td> 
                        <td  style="border: 1px solid;">
                            <div class="row">
                                <div class="col-md-12">
                                    <label style="font-size:12px !important;"><b>Enter Product Name<span style="color:red;">*</span></b></label>
                                    <input type="text" value=""  id="rentalProductId" placeholder="PRODUCT NAME" class="form-control">
                                </div> 
                                <div class="col-md-12">
                                    <div style="margin-bottom: 0rem;" class="form-group">
                                        <label style="font-size:12px !important;"><b>Enter Qty<span style="color:red;">*</span></b></label>
                                        <input type="text" value=""  id="rentalQty"  onkeypress="return isNumberKey(event)" placeholder="QUANTITY" class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div style="margin-bottom: 0rem;" class="form-group">
                                        <label style="font-size:12px !important;">Select Unit<span style="color:red;">*</span></b></label>
                                        {{Form::select('rentalUnitId', $units, null, ['class'=>'form-control', 'placeholder'=>'Select a Unit', 'id'=>'rentalUnitId'])}}
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div style="margin-bottom: 0rem;" class="form-group">
                                        <label style="font-size:12px !important;">Description</label>
                                        <input type="text" value=""  id="rentalDescription" placeholder="DESCRIPTION" class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div style="margin-bottom: 0rem;" class="form-group mt-4">
                                        <label style="font-size:12px !important;"></label>
                                        <button type="button" id="addRentalProductRequisitionRow" class="btn btn-primary" style="font-size:15px !important;">+&nbsp;&nbsp;Add</button>
                                    </div>
                                </div>
                            </div>      
                        </td> 
                        ...
                        <table class="table table-bordered mb-0" id="myTable1" width="100%">
                            <thead class="bg-white text-uppercase">
                                <tr class="ligth ligth-data">
                                    ...
                                    <th  style="padding: 0px 4px !important;font-size:13px;" width="15%"  class="text-center">Image</th>
