                ...
                <div class="card-header">
                    <div class="col-lg-12">
                        <div class="d-flex flex-wrap align-items-center justify-content-between">
                            <div  class="col-lg-"><b style="color:red;">Purchase Order Report</b></div>
                            <div  class="col-lg-4"></div>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    {!! Form::open(['action' => 'storeController\ReportsController@purchaseOrderReport', 'method' => 'GET', 'class' => 'form-horizontal']) !!}
                        <div class="row">
                            <div class="col-md-2">
                            ...
                            <div class="table-responsive" width="100%">
                                @if(count($reports))
                                    <table id="datatable" width="100%" class="table table-bordered data-table  table-striped" style="">
                                        <thead class="bg-white text-uppercase">
                                            <tr class="ligth ligth-data">
                                                ...
                                                <th style="font-size:14px;white-space: nowrap;" width="10%">PO Number<?php $i=1; ?></th>
                                            </tr>
                                        </thead>
                                    ...
                                    <div class="row" style="margin-top:15px;">
                                        ...
                                        <div class='col-md-4'>
                                            <form action="{{ route('export.purchaseOrderReportExport') }}" method="GET">
