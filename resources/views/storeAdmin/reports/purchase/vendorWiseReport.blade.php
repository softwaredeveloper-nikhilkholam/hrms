    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    {!! Form::open(['action' => 'storeController\ReportsController@vendorWiseReport', 'method' => 'GET', 'class' => 'form-horizontal']) !!}
                        <div class="row">
                            <div class="col-md-2">
                                <div class="form-group">
                                    {{Form::select('vendorId', $vendors, $vendorId, ['placeholder'=>'Select Vendor','class'=>'form-control', 'id'=>'vendorId', 'required'])}}
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group">
                                    <input type="date" name="startDate" class="form-control" value="{{$startDate}}" placeholder="Start Date" required>
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group">
                                    <input type="date" name="endDate" class="form-control" value="{{$endDate}}" placeholder="End Date" required>
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group">
                                    {{Form::select('type', ['1'=>'Quotation', '2'=>'Work Order'], $type, ['placeholder'=>'Select Type','class'=>'form-control', 'id'=>'type', 'required'])}}
                                </div>
                            </div>
