                ...
                <div class="card-header">
                    <div class="col-lg-12">
                        <div class="d-flex flex-wrap align-items-center justify-content-between">
                            <div  class="col-lg-"><b style="color:red;">Inward Report</b></div>
                            <div  class="col-lg-4"></div>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    {!! Form::open(['action' => 'storeController\ReportsController@inwardReport', 'method' => 'GET', 'class' => 'form-horizontal']) !!}
                        <div class="row">
                            <div class="col-md-3">
                            ...
                            <div class="col-lg-12">
                                <div class="table-responsive" width="100%">
                                    <table id="datatable" width="100%" class="table table-bordered data-table  table-striped" style="">
                                        <thead class="bg-white text-uppercase">
                                            <tr class="ligth ligth-data">
                                                ...
                                                <th style="font-size:14px;white-space: nowrap;">Requisition No</th>
                                        ...
                                        <tbody class="ligth-body">
                                            @foreach($reports as $row)
                                                <tr>
                                                    ...
                                                    <td style="padding: 0px 17px !important;font-size:12px;white-space: nowrap;text-align:left;">{{$row->reqNo}}</td>
                                                    <td style="padding: 0px 17px !important;font-size:12px;white-space: nowrap;text-align:left;">{{($row->active == 0)?'Rejected':'Approved'}}</td>
                                                </tr>
                                            @endforeach                                            
                                        </tbody>
                                    </table>
                                    <div class="row" style="margin-top:15px;">
                                        ...
                                        <div class='col-md-4'>
                                            <form action="{{ route('export.inwardReportExport') }}" method="GET">
