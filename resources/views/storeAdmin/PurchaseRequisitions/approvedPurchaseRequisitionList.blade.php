            ...
            <div class="card-header">
                <div class="col-lg-12">
                    <div class="d-flex flex-wrap align-items-center justify-content-between">
                        <div  class="col-lg-4"><b style="color:red;">Approved Purchase Requisition List</b></div>
                        <div  class="col-lg-8 text-right">
                            ...
                            <a href="/requisitions/approvedPurchaseRequisitionList" class="btn mb-1 btn-success">Approved List</a>                           
