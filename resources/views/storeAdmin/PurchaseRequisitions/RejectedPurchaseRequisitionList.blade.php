            ...
            <div class="card-header">
                <div class="col-lg-12">
                    <div class="d-flex flex-wrap align-items-center justify-content-between">
                        <div  class="col-lg-4"><b style="color:red;">Rejected Purchase Requisition List</b></div>
                        <div  class="col-lg-8 text-right">
                            ...
                            <a href="/requisitions/rejectedPurchaseRequisitionList" class="btn mb-1 btn-success">Rejected List</a>                         
                        </div>
                    </div>
                </div>
            </div>
