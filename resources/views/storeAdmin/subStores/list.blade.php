                ...
                <div class="col-lg-12">
                    <div class="d-flex flex-wrap align-items-center justify-content-between">
                        ...
                        <div  class="col-lg-5">
                            ...
                            <a href="/assetProducts" class="btn mb-1 btn-primary">
                                ...
                                <table id="datatable" data-page-length='25' class="table table-bordered data-table table-striped" style="font-size:12px;">
                                    <thead>
                                        <tr class="ligth">
                                            ...
                                            <th style="font-size:13px;">Category Name</th>
                                            <th style="font-size:13px;">Product Name</th>
                                            <th style="font-size:13px;">Installation Date</th>
                                    ...
                                    <tbody>
                                        @foreach($products as $row)
                                            <tr>
                                                ...
                                                <td style="padding: 0px 17px !important;">{{$row->installationDate}}</td>
                                                <td style="padding: 0px 17px !important;">{{$row->qty}}</td>
                                                <td style="padding: 0px 17px !important;">{{$row->created_at}}</td>
                                                <td style="padding: 0px 17px !important;">
                                                    <div class="d-flex align-items-center list-action">
                                                        ...
                                                        href="/assetProducts/{{$row->id}}"><i class="fa fa-eye"></i></a>
                                                        <a class="badge bg-success mr-2" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit {{$row->name}}"
                                                            href="/assetProducts/{{$row->id}}/edit"><i class="ri-pencil-line mr-0"></i></a>
                                                        <a class="badge bg-warning mr-2" data-toggle="tooltip" data-placement="top" title="" data-original-title="Deactivate {{$row->name}}"
