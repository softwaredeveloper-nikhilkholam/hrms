...
<style>
    ...
    * {
    ...
    #datatable thead tr th {
        ...
        background-color: #e3d549a1; /* Light background for headers */
                ...
                <div class="card-header">
                    <div class="col-lg-12">
                        <div class="d-flex flex-wrap align-items-center justify-content-between">
                            <div class="col-lg-"><b style="color:red;">PO Unpaid List</b></div>
                            <div class="col-lg-4">
                                <a href="/payments/POUnpaidPaymentList" class="btn mb-1 btn-success">Pending List</a>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            @if(count($payments))
                                            ...
                                            @foreach($payments as $payment)
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        ...
                                                        @else
                                                            <a href="/purchaseOrder/viewPONumber/{{base64_encode($payment->poNumber)}}" class="badge bg-warning mr-2" style="color:black;" target="_blank"><i class="fa fa-eye"></i></a>
                                                        @endif
                                                    </td>
                                                </tr>
                                            @endforeach
                                ...
                                <a href="/payments/0/1/0/exportPOPayments" class="btn mb-1 btn-success mt-5">Export&nbsp;&nbsp;<i class="fa fa-file-excel"></i></a>
                            @else
