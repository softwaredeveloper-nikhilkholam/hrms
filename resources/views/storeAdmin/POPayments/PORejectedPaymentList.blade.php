...
<style>
    ...
    * {
    ...
    #datatable thead tr th {
        ...
        background-color: #e37249a1; /* Light background for headers */
                    ...
                    <div class="col-lg-12">
                        <div class="d-flex flex-wrap align-items-center justify-content-between">
                            ...
                            <div  class="col-lg-4">
                                ...
                                <a href="/payments/PORejectedPaymentList" class="btn mb-1 btn-success">Rejected List</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    {!! Form::open(['action' => 'storeController\PaymentsController@PORejectedPaymentList', 'method' => 'GET', 'class' => 'form-horizontal']) !!}
                        <div class="row ">
                    ...
                    <div class="col-lg-12">
                            @if(count($payments))
                                ...
                                <div class="col-md-2 text-right">
                                    <a href="/payments/{{$forMonth}}/3/{{($selectedTypeOfCompany == '')?'0':$selectedTypeOfCompany}}/exportPOPayments" class="btn mb-1 btn-success mt-5">Export&nbsp;&nbsp;<i class="fa fa-file-excel"></i></a>
                                </div>
                            @else
