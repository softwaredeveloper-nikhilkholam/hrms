...
<div class="row justify-content-center">
    <div class="card">
        ...
        <div class="card-body">
            {!! Form::open(['action' => ['storeController\AssetProductsController@update', $assetProduct->id], 'method' => 'POST', 'class' => 'form-horizontal', 'enctype'=>'multipart/form-data']) !!}
            <div class="card">
                <div class="card-body">
                <div class="row">
                        <div class="col-md-3">
                        ...
                        <div class="col-md-3">                      
                            <div class="form-group">
                                ...
                                <b style="color:red;">{{$assetProduct->productPhoto}}</b>
                                <input type="file" class="form-control" style="line-height: 15px !important;"  value="{{$assetProduct->productPhoto}}" name="photoUpload" placeholder="Enter Photo uploading"  required>
                                <div class="help-block with-errors"></div>
                            </div>
                        </div>   
                    </div>
