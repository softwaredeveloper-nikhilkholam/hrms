                ...
                <div class="col-lg-12">
                    <div class="d-flex flex-wrap align-items-center justify-content-between">
                        ...
                        <div  class="col-lg-5">
                            ...
                            <a href="/assetProducts/dlist" class="btn mb-1 btn-success">
                                            ...
                                            <tr>
                                                ...
                                                <td style="padding: 0px 17px !important;">
                                                    <div class="d-flex align-items-center list-action">
                                                        ...
                                                        <a class="badge bg-success mr-2" onclick="return confirm('Are you sure?')" data-original-title="Deactivate {{$row->name}}"
                                                            href="/assetProducts/{{$row->id}}/activate"><i class="fa fa-check mr-0"></i></a>
                                                    </div>
                                                </td>
                                            </tr>
                                        @endforeach
