                ...
                <div class="card-header">
                    <div class="col-lg-12">
                        <div class="d-flex flex-wrap align-items-center justify-content-between">
                            <div  class="col-lg-7"><b style="color:red;">Active Hall List</b></div>
                            <div  class="col-lg-5">
                                ...
                                <a href="/hall" class="btn mb-1 btn-primary">
                                    Active List <span class="badge badge-danger ml-2">{{count($halls)}}</span>
                                </a>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <tbody>
                                            @foreach($halls as $hall)
                                                <tr>
                                                    ...
                                                    <td style="padding: 0px 17px !important;">{{date('d-m-Y', strtotime($hall->updated_at))}}</td>
                                                    ...
                                                    <td style="padding: 0px 17px !important;">
                                                        <div class="d-flex align-items-center list-action">
                                                            ...
                                                            <a class="badge bg-danger mr-2" data-toggle="tooltip" data-placement="top" title="" data-original-title="Deactivate"
                                                                href="/hall/{{$hall->id}}/deactivate"><i class="ri-delete-bin-line mr-0"></i></a>
                                                        </div>
                                                    </td>
                                                </tr>
                                            @endforeach
