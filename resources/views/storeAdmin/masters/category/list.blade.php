                ...
                <div class="card-header">
                    <div class="col-lg-12">
                        <div class="d-flex flex-wrap align-items-center justify-content-between">
                            <div  class="col-lg-7"><b style="color:red;">Active Product Category List</b></div>
                            <div  class="col-lg-5">
                                ...
                                <a href="/category" class="btn mb-1 btn-success">Active List <span class="badge badge-danger ml-2">{{$categoriesCt}}</span></a>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="table-responsive rounded mb-3">
                                @if(count($categories))
                                                    ...
                                                    <td style="padding: 0px 17px !important;font-size:12px;white-space: nowrap;text-align:left;">
                                                        <div class="d-flex align-items-center list-action">
                                                            ...
                                                            <a class="badge bg-warning mr-2" data-toggle="tooltip" data-placement="top" title="" data-original-title="Deactivate"
                                                                href="/category/{{$category->id}}/deactivate"><i class="ri-delete-bin-line mr-0"></i></a>
                                                        </div>
                                                    </td>
                                                </tr>
                                            @endforeach
                                    ...
                                    <div class="row" style="margin-top:15px;margin-bottom:15px;">
                                        ...
                                        <div class='col-md-3'><a class="btn btn-danger btn-bg"  href="/categories/exportToExcel/1" target="_blank">Export Excel</a></div>
                                    </div>
                                @else
