    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <div class="col-lg-12">
                        <div class="d-flex flex-wrap align-items-center justify-content-between">
                            <div  class="col-lg-7"><b style="color:red;">Edit Sub Category</b></div>
                            <div  class="col-lg-5">
                ...
                <div class="card-body">
                    {!! Form::open(['action' => ['storeController\SubCategoriesController@update', $subCategory->id], 'method' => 'POST', 'class' => 'form-horizontal', 'enctype'=>'multipart/form-data']) !!}
                        <div class="row">  
                            <div class="col-md-4">                      
                                <div class="form-group">
                                    <label>Select Category<span style="color:red;">*</span></label>
                                    {{Form::select('categoryId', $categories, $subCategory->categoryId, ['class'=>'form-control', 'placeholder'=>'Select a Option', 'required', 'id'=>'categoryId'])}}
