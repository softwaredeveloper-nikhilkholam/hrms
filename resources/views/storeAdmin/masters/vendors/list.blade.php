                    ...
                    <div class="col-lg-12">
                        <div class="d-flex flex-wrap align-items-center justify-content-between">
                            ...
                            <div  class="col-lg-4">
                                ...
                                <a href="/vendor/dlist" class="btn mb-1 btn-primary btn-lg">Deactive List <span class="badge badge-danger ml-2">{{$dVendors}}</span></a>
                                <a href="/vendor" class="btn mb-1 btn-success btn-lg">Active List <span class="badge badge-danger ml-2">{{count($vendors)}}</span></a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    {!! Form::open(['action' => 'storeController\VendorsController@index', 'method' => 'GET', 'class' => 'form-horizontal']) !!}
                        <div class="row">
                            <div class="col-md-3">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="table-responsive rounded mb-3">
                                @if(count($vendors))
                                    <table  class="table table-bordered  table-stripedfont-size:12px;">
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="padding: 0px 17px !important;font-size:14px;white-space: nowrap;" class="text-left">
                                                        <div class="d-flex align-items-center list-action">
                                                            ...
                                                            <a class="badge bg-danger mr-2" data-toggle="tooltip" data-placement="top" title="" data-original-title="Deactivate"
                                                                href="/vendor/{{$vendor->id}}/deactivate"><i class="ri-delete-bin-line mr-0"></i></a>
                                                        </div>
                                                    </td>
                                                </tr>
                                            @endforeach
                                    ...
                                    <div class="row" style="margin-top:15px;">
                                        ...
                                        <div class='col-md-4 text-right'>
                                            <a class="badge bg-primary  btn-lg" href="/vendor/1/exportExcel"><i class="fa fa-excel mr-0"></i>Export</a>
                                        </div>
                                    </div>
                                @else
