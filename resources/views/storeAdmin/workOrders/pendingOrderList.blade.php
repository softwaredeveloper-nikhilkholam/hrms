    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                    ...
                    <div class="col-lg-12">
                        <div class="d-flex flex-wrap align-items-center justify-content-between">
                            ...
                            <div  class="col-lg-6 text-right">
                                ...
                                @endif
                                <a href="/workOrder" class="btn mb-1 btn-success">Pending List</a>
                ...
                <div class="card-body">
                    {!! Form::open(['action' => 'storeController\WorkOrdersController@index', 'method' => 'GET', 'class' => 'form-horizontal']) !!}
                        <div class="row">
                            <div class="col-md-2">
                                    ...
                                    <table id="datatable" data-page-length='25' class="table table-bordered data-table table-striped" style="">
                                        <thead class="bg-white text-uppercase">
                                            <tr class="ligth ligth-data">
                                                ...
                                                <th style="font-size:12px;" width="3%">WO GP No</th>
                                            ...
                                            @foreach($orders as $order)
                                                @if($temp != $order->commWONo)
                                                    <tr>
                                                        ...
                                                        <td style="padding: 0px 10px !important;font-size:10px;text-align:center;">{{$order->commWONo}}</td>
                                                        ...
                                                        <td style="padding: 0px 10px !important;font-size:10px;text-align:center;">
                                                            <div class="d-flex align-items-center list-action">
                                                                ...
                                                                <a class="badge bg-danger mr-2" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete Work Order"
                                                                    href="/workOrder/{{$order->commWONo}}/deactivate" onclick="return confirm('Are you sure to Delete Work Order....?')"><i class="fa fa-trash mr-0"></i></a>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                @endif
