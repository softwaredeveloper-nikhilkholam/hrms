                ...
                <div class="col-lg-12">
                    <div class="d-flex flex-wrap align-items-center justify-content-between">
                        ...
                        <div  class="col-lg-4 text-right">
                            ...
                            <a href="/requisitions/purchaseRequisitionList" class="btn mb-1 btn-success">
                                        ...
                                        @foreach($requisitions as $row)
                                            ...
                                            @endif
                                                ...
                                                <td style="padding: 2px 17px !important;">
                                                    ...
                                                    @endif   
                                                    <a href="/requisitions/purchaseRequisitionView/{{$row->id}}" style="font-size: 12px !important;" class="btn btn-primary" ><i class="fa fa-eye" data-toggle="tooltip" data-original-title="Show Requisition Details"></i></a>                                                 
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
