            ...
            <div class="col-lg-12">
                <div class="d-flex flex-wrap align-items-center justify-content-between">
                    ...
                    <div  class="col-lg-5 text-right">
                        <a href="/requisitions/raiseRequisition" class="btn mb-1 btn-success">Raise Requisition</a>
                        <a href="/requisitions" class="btn mb-1 btn-primary">
                            Requisition List <span class="badge badge-danger ml-2">0</span>
                        </a>
