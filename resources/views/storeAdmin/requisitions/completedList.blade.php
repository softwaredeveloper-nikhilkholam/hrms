            ...
            <div class="card-header">
                <div class="col-lg-12">
                    <div class="d-flex flex-wrap align-items-center justify-content-between">
                        <div  class="col-lg-4"><b style="color:red;">Completed Requisition List <b style="color:blue;">({{$reqCount}})</b></b></div>
                        <div  class="col-lg-8 text-right">
                            ...
                            <a href="/requisitions/completedReqList" class="btn mb-1 btn-success">Completed List</a>       
                                        ...
                                        @foreach($requisitions as $row)
                                            ...
                                            @endif
                                                ...
                                                <td style="padding: 2px 17px !important;">
                                                    ...
                                                    @else
                                                        @if($row->status == 0)
                                                            <a href="/requisitions/{{$row->id}}/deactivate" onclick="return confirm('Are you sure?')">
