                    ...
                    <div class="col-lg-12">
                        <div class="d-flex flex-wrap align-items-center justify-content-between">
                            ...
                            <div  class="col-lg-4 text-right">
                                <a href="/purchaseOrder/purchaseOrderList" class="btn mb-1 btn-primary">Unpaid PO</a>
                                <a href="/purchaseOrder/paidPurchaseOrderList" class="btn mb-1 btn-success">Paid PO</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    {!! Form::open(['action' => 'storeController\PurchaseTransactions@paidPurchaseOrderList', 'method' => 'GET', 'class' => 'form-horizontal']) !!}
                        <div class="row">
                            <div class="col-md-2">
