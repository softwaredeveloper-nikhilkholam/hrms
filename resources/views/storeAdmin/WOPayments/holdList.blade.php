...
<style>
    ...
    * {
    ...
    #datatable thead tr th {
        ...
        background-color: #49e385a1; /* Light background for headers */
                ...
                <div class="card-header">
                    <div class="col-lg-12">
                        <div class="d-flex flex-wrap align-items-center justify-content-between">
                            <div  class="col-lg-"><b style="color:red;">Hold WorkOrder List</b></div>
                            <div  class="col-lg-4">
                                ...
                                <a href="/WOPayments/WOHoldPayments" class="btn mb-1 btn-success">Hold List</a>
                                <a href="/WOPayments/WORejectedPayments" class="btn mb-1 btn-primary">Rejected List</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    {!! Form::open(['action' => 'storeController\WorkOrdersController@WOHoldPayments', 'method' => 'GET', 'class' => 'form-horizontal']) !!}
                        <div class="row mt-2">
                            <div class="col-md-2">
                        ...
                        <div class="col-lg-12">
                            @if(count($payments))
                                ...
                                <div class="col-md-2 text-right">
                                    <a href="/WOPayments/{{$forMonth}}/2/{{($selectedTypeOfCompany == '')?0:$selectedTypeOfCompany}}/exportWOPayments" class="btn mb-1 btn-success mt-5">Export&nbsp;&nbsp;<i class="fa fa-file-excel"></i></a>
                                </div>
                            @else
